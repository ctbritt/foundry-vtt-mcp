...
class PersistentCreatureIndex {
     ...
     */
    async extractEnhancedDataFromPack(pack) {
        const creatures = [];
        let errors = 0;
        try {
     ...
     */
    extractEnhancedCreatureData(doc, pack) {
        try {
...
export class FoundryDataAccess {
     ...
     */
    calculateTokenPosition(placement, scene, index) {
     ...
     */
    broadcastRollState(buttonId, _rollState) {
