...
export class RunPodClient {
  ...
  constructor(options: { logger: Logger; config: RunPodConfig }) {
   ...
   */
  async submitJob(input: RunPodWorkflowInput): Promise<RunPodJobResponse> {
    try {
   ...
   */
  private buildWorkflow(input: RunPodWorkflowInput): Record<string, any> {
