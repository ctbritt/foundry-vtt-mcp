...
export class CompendiumTools {
    ...
    async handleSearchCompendium(args) {
        ...
        try {
            ...
            return {
                query,
                results: limitedResults.map((item) => this.formatCompendiumItem(item)),
                totalFound: results.length,
    ...
    async handleListCreaturesByCriteria(args) {
        ...
        try {
            ...
            return {
                creatures: (results.response?.creatures || results).map((creature) => this.formatCreatureListItem(creature)),
    ...
    formatCreatureListItem(creature) {
