...
VIAddVersionKey "FileVersion" "0.4.13.0"
...
Section "Foundry MCP Server" SecMain
  ...
  WriteRegStr HKCU "Software\Microsoft\Windows\CurrentVersion\Uninstall\FoundryMCPServer" "DisplayVersion" "0.4.13"
